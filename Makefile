...
run-client:
	@$(GO) run cmd/client/main.go --name george --password gg101
	@$(GO) run cmd/client/main.go --name matteo --password mypassword
	@$(GO) run cmd/client/main.go --name john --password pwd
